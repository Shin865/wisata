                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" method="post" action="<?php echo site_url('wislish/edit');?>" novalidate>
                                    <!-- <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">  -->
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <select class="form-control" name="statuskunjungan" value="<?php echo $wishlist->statuskunjungan;?>">
                        <?php foreach($wishlist as $val){ ?>
                        <option ><?php echo $val->statuskunjungan;?></option>
                    <?php }?>
                        </select>
                                            </div>
                                        </div>
